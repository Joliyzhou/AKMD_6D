...
/* For Gyroscope */
#define EVENT_TYPE_GYRO_X           ABS_WHEEL
#define EVENT_TYPE_GYRO_Y           ABS_GAS
#define EVENT_TYPE_GYRO_Z           ABS_BRAKE
#define EVENT_TYPE_GYRO_STATUS      ABS_HAT0X
...
/* Fusion Gravity */
#define EVENT_TYPE_GRAVITY_X        ABS_HAT2X
#define EVENT_TYPE_GRAVITY_Y        ABS_HAT2Y
#define EVENT_TYPE_GRAVITY_Z        ABS_HAT3X

/* Fusion Linear Acceleration */
#define EVENT_TYPE_LACCEL_X         ABS_HAT3Y
#define EVENT_TYPE_LACCEL_Y         ABS_PRESSURE
#define EVENT_TYPE_LACCEL_Z         ABS_DISTANCE
...
/* conversion of PseudoGyro output (Q16) data to float */
#define CONVERT_G					CONVERT_Q16
#define CONVERT_GR					CONVERT_Q16
#define CONVERT_LA					CONVERT_Q16
#define CONVERT_RV					CONVERT_Q16
